...
> Which model has a lower loss? Stock predictor
>
> Which model tracks the actual values better over time? Stock predictor
>
> Which window size works best for the model? window 10
